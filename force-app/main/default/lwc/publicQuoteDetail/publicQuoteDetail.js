...
export default class publicQuoteDetail extends NavigationMixin(LightningElement) {
    ...
    getQuoteDetails(){
        ...
        getQuoteDetails({ quoteId: this.recordid }).then((res)=>{
            ...
            this.quoteDetails=res?.map((item,ind)=>({
                ...
                GrandTotal:item.Grand_Total_price__c
            }));
    ...
    handleApprove() {
        ...
        updateQuoteStatus({ quoteId: this.recordid , customerResponse: this.customerResponse})
            .then((result) => {
    ...
    handleReject() {
        ...
        updateQuotedenied({ quoteId: this.recordid , customerResponse: this.customerResponse})
            .then((res) => {
                console.log(res)
    ...
    handleResponse(event){
        this.customerResponse = event.target.value;
        console.log('log customer response--->' +this.customerResponse);
    }
}